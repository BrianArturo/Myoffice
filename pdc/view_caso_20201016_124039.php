      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <input type="hidden" class="form-control" id="caso_id" name="caso_id"
            value="<?php echo rawurlencode(base64_encode(auyama_encrypt($c["caso_id"]))); ?>">
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row" id="infobox">
        ...
        <div class="col-md-12">
          <div class="form-group form-inline">
            ...
            <input type="text" class="form-control hidden4ajax ml-1" id="caso_name_field" name="caso_name_field"
              value="<?php echo $c["name"]; ?>" />
            <button type="button" id="caso_name_field_save"
              class="btn btn-danger btn-sm hidden4ajax ml-1">guarda</button>
          </div>
        </div>
        ...
        <div class="col-md-3  ">
          <div class="form-group form-inline">
            ...
            <div class="hidden4ajax" id="caso_code_container">
              <input type="text" class="form-control hidden4ajax ml-1" id="caso_code_field" name="caso_code_field"
                value="<?php echo $c["code"]; ?>" />
              <button type="button" id="caso_code_field_save"
                class="btn btn-danger btn-sm hidden4ajax ml-1 ">Guarda</button>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-3 form-inline mitimiti">
          <select class="form-control custom-select small_on_mobile" id="status" name="status" required>
            ...
            <?php
                  ...
                  ?>
          </select><button id="save_status_caso" class="btn btn-primary text-center" data-toggle="tooltip" data-placement="top" title="Actualisa status del caso"> <i class="fa fa-floppy-o  " aria-hidden="true"> </i> Actualizar</button>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3  ">
          <div class="form-group form-inline">
            ...
            <span id="cuantia_caso"> <?php   
            echo empty($c["cuantia"])  ? "Vacio!" : "$ ".number_format($c["cuantia"], 0);
            
            
            ?></span>
            <div class="hidden4ajax" id="cuantia_caso_container" style="display:none">
              <input data-type="currency" type="text" class="form-control hidden4ajax  ml-1" id="cuantia_caso_field"
                name="cuantia_caso_field" value="<?php echo "$".number_format($c["cuantia"], 0); ?>" />
              <button type="button" id="cuantia_caso_field_save"
                class="btn btn-danger btn-sm ml-1 hidden4ajax">guarda</button>
            </div>
          </div>
        </div>
        <?php
      ...
      <div class="row">
          ...
          <div class="row">
            <div class="col-md-5">
              <input type="text" class="form-control" id="contact_name" name="contact_name"
                placeholder="Busca contacto por nombre ">
            ...
            <div class="col-md-2">
              ...
              <input type="text" class="form-control" id="contact_name_new" name="contact_name_new"
        ...
        <div class="col-md-12">
          <form method="post">
            ...
            <hr>
            <textarea name="notes" id="notes" class="notes"
              style="width:100%;"><?php echo $c["description"]; ?></textarea>
        </div>
        <div class="col-md-12">
        ...
        <div class="col-md-12 mt-3">
          <h3>
            <button type="button" id="add_note" name="add_note" class="btn btn-secondary" data-toggle="tooltip"
              data-placement="top" title="Agrega una nota">
        ...
        <div class="col-md-12 mt-3">
          <h3>
            <button type="button" id="ver_pagos" name="ver_pagos" class="btn btn-secondary" data-toggle="collapse"
              href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample"
              data-placement="top" title="Ver Pagos del caso">
              <i class="fa fa-plus fa-2x" aria-hidden="true"></i>
            </button> Pagos
          </h3>
          <hr>
...
-->
        ...
        <div class="col-md-12 mt-3 pt-3">
          <h3 class="col-md-8">
            <a
              href="documentos.php?id=<?php echo rawurlencode(base64_encode(auyama_encrypt($c["caso_id"]))); ?>&count=<?php echo rawurlencode(base64_encode(auyama_encrypt($count))); ?>&documentcount=<?php echo rawurlencode(base64_encode(auyama_encrypt($document_count["total"]))); ?>">
              <button type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="top"
                title="Agrega un documento">
                <i class="fa fa-plus fa-2x" aria-hidden="true"></i>
              </button>
            </a>
			 Documentos-Cantidad:<?php echo $document_count["total"]?> 
			 
          </h3>
			<div class="col-md-4">
			  	<input id="buscar" class="form-control" type="text" placeholder="Buscar Documento..." onkeyup="buscar()"> 
			  </div>
          <hr>
        </div>
