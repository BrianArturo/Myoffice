...
<div id="mywidgetframe">
    ...
    <?php
          ...
          ?>
        <ul class="nav nav-tabs mb-3 pb-3 " role="tablist">
            <li class="active m-auto " ><a href="#opciones" role="tab" data-toggle="tab" class="btn btn-primary">Opciones </a></li>
            <li  class="m-auto" ><a href="#pagos" role="tab" data-toggle="tab" class="btn btn-primary"> Pagos</a></li>
        </ul>
        <?php
