...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        global $attachment_allow;
        $this->response = array();
        $this->options = array(
            'script_url' => $this->get_full_url().'/'.$this->basename($this->get_server_var('SCRIPT_NAME')),
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'../../download/',
            ...
            'accept_file_types' => '/\.('.$attachment_allow.'|gif|jpe?g|png)$/i',
    ...
    protected function set_additional_file_properties($file) {
        ...
        $file->deleteType = $_FILES['files']['name'];
    ...
    protected function generate_unique_filename($filename = "")
    {
        ...
        return date("Y-m-d-h-i-").md5(uniqid()) . $extension;
    }
